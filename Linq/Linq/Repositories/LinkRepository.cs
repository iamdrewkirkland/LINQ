...
namespace Linq.Repositories
{
    public class LinkRepository
    {
        ...
        public List<Link> GetRequestedLinks(int requestUserId, int categoryId)
        {
            return _context.UserApprovedList
                        .Include(l => l.Category)
                        .Include(l => l.UserProfile)
                        .Where(l => l.SharedUserId == requestUserId && l.CategoryId == categoryId)
                        .SelectMany(u => u.Category.UserLinks)
                        .ToList();
        }
